...
Sign up for a free VictorChat account and start live support on your website within 5 minuttes.
Installation is easy and no HTML skills are required.

If needed we even makes the setup for free, just request it online at www.VictorChat.dk


**Key Features**

* **Computer, Laptop, Tablet, Smartphone:** Your customers can chat with you from any device, as our website and admin panels are created in responsive design
* **Mobile Optimized:** Live chat with your customers using our mobile app
* **Customize chat window:** Make the chat window personal by customize it to fit your website 
* **Support anywhere:** Simply launch a web browser on any Computer, Laptop, Tablet or Smartphone anywhere in the world and start supporting visitors on your website
* **Multi Languages:** VictorChat is translated into Danish and English in both front and backend (more languages are soon to come)

**What makes VictorChat the best choice for live chat?**

* We’re the most popular live chat system in Denmark - Used by over 150,000 businesses and private users
* A simple and highly customizable live chat to add to your website, blog and Webshop
* Installation is easy and no HTML skills are required.

** Technical explanation Facts**
...
Should you need any assistance, please contact our support on www.victorchat.dk
...
1. <a href="http://www.victorchat.dk/signup.php?lang=en">Sign up </a> for a FREE account!
2. Log into your free owner account an Create a Department and an Agent
3. Assign the Agent to the Department
4. Click 'Code & Setup' in the left site menu and copy the HTML code from there
5. Log into your WordPress admin site again and click 'VictorChat' in the left site menu
6. Paste the HTML code into the below field 
7. Click the 'Save' button
8. The WordPress plugin is now setup
9. log into your Agent account using the 'Agent email and password' you just created and start supporting
...
5. Mobile App: Shown how the mobile App works


== Free account ==

1. This plugin makes it possible to setup your free VictorChat account on WordPress - We hope you enjoy it
...
Dont worry, just visit our website at www.victorchat.dk and we will help you with the installation for free.
